...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        user.setCar(new Car("model1", 154789l));
        userService.add(user);
        User user2 = new User("User2", "Lastname2", "user2@mail.ru");
        user2.setCar(new Car("model2", 784579l));
        userService.add(user2);
        User user3 = new User("User3", "Lastname3", "user3@mail.ru");
        user3.setCar(new Car("model3", 784968l));
        userService.add(user3);
        User user4 = new User("User4", "Lastname4", "user4@mail.ru");
        user4.setCar(new Car("model4", 635779l));
        ...
        System.out.println("Find user by car : " + userService.getUserByCar(new Car("model4", 635779l)));
